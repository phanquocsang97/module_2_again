package ss15_exception.expense_model;

public class Expense implements Comparable<ss14_sort.expense_model.Expense> {
    ...
    @Override
    public int compareTo(ss14_sort.expense_model.Expense o) {
